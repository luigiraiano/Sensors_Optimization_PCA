%% Run Performance Static Analysis, v3, 28-04-2020
...
% SPIROF=500; GARMENTF=500;  
SOGLIAREF=90; SOGLIAGARM=50; SOGLIAPCA=50;
...
%% Breath-by-Breath analysis for all subjects REF VS PCA_nonred
...
figure('Renderer', 'painters', 'Position', [100 100 300 300])
plot(fRref.S1,fPCA_nonred.S1,'o')
plot([fRref.S1 fRref.S2 fRref.S3 fRref.S4 fRref.S5 fRref.S6 fRref.S7 fRref.S8 fRref.S9 fRref.S10],[fPCA_nonred.S1 fPCA_nonred.S2 fPCA_nonred.S3 fPCA_nonred.S4 fPCA_nonred.S5 fPCA_nonred.S6 fPCA_nonred.S7 fPCA_nonred.S8 fPCA_nonred.S9 fPCA_nonred.S10],'o')

BbB_reference_static=[fRref.S1 fRref.S2 fRref.S3 fRref.S4 fRref.S5 fRref.S6 fRref.S7 fRref.S8 fRref.S9 fRref.S10]';
BbB_PCA_nonred_static=[fPCA_nonred.S1 fPCA_nonred.S2 fPCA_nonred.S3 fPCA_nonred.S4 fPCA_nonred.S5 fPCA_nonred.S6 fPCA_nonred.S7 fPCA_nonred.S8 fPCA_nonred.S9 fPCA_nonred.S10]';

[BbB_reference_static BbB_PCA_nonred_static BbB_PCA_nonred_static-BbB_reference_static]
MAE_static=1/length(BbB_PCA_nonred_static)*(sum(abs(BbB_PCA_nonred_static-BbB_reference_static)))
SE_static=std(abs(BbB_PCA_nonred_static-BbB_reference_static))/sqrt(length(BbB_PCA_nonred_static))
ERR_PERC=mean(abs(((((BbB_PCA_nonred_static-BbB_reference_static))./BbB_reference_static)*100)))
ERR_PERC=mean((((((BbB_PCA_nonred_static-BbB_reference_static))./BbB_reference_static)*100)))

% hist(BbB_PCA_static-BbB_reference_static)

BbB_reference_static=BbB_reference_static';
BbB_PCA_nonred_static=BbB_PCA_nonred_static';

figure()
[fitresult, gof] = createFit(BbB_reference_static, BbB_PCA_static)
close all
figure('Renderer', 'painters', 'Position', [100 100 400 400])
plot (fRref.S1,fPCA_nonred.S1, 'ko','MarkerSize',6,'linewidth',1,'MarkerFaceColor','k'); hold on;
plot (fRref.S2,fPCA_nonred.S2, 'ko','MarkerSize',6,'linewidth',1,'MarkerFaceColor','b')
plot (fRref.S3,fPCA_nonred.S3, 'ko','MarkerSize',6,'linewidth',1,'MarkerFaceColor','m')
plot (fRref.S4,fPCA_nonred.S4, 'ko','MarkerSize',6,'linewidth',1,'MarkerFaceColor','r')
plot (fRref.S5,fPCA_nonred.S5, 'ko','MarkerSize',6,'linewidth',1,'MarkerFaceColor','c')
plot (fRref.S6,fPCA_nonred.S6, 'k^','MarkerSize',6,'linewidth',1,'MarkerFaceColor','k');
plot (fRref.S7,fPCA_nonred.S7, 'k^','MarkerSize',6,'linewidth',1,'MarkerFaceColor','b')
plot (fRref.S8,fPCA_nonred.S8, 'k^','MarkerSize',6,'linewidth',1,'MarkerFaceColor','m')
plot (fRref.S9,fPCA_nonred.S9, 'k^','MarkerSize',6,'linewidth',1,'MarkerFaceColor','r')
plot (fRref.S10,fPCA_nonred.S10, 'k^','MarkerSize',6,'linewidth',1,'MarkerFaceColor','c')
plot(0:max(BbB_reference_static+1),fitresult(0:max(BbB_reference_static+1)),'k-.','linewidth',2)
xlabel ('f_{R_{F}} [breaths\cdotmin^{-1}]')
ylabel ('f_{R_{PCA}} [breaths\cdotmin^{-1}]')
set(gca,'FontSize',14)
...
title('Correlation analysis - Static')
figure('Renderer', 'painters', 'Position', [100 100 600 350])
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S1',fRref.S1'], 'k','o')
hold on
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S2',fRref.S2'], 'b','o')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S3',fRref.S3'], 'm','o')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S4',fRref.S4'], 'r','o')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S5',fRref.S5'], 'c','o')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S6',fRref.S6'], 'k','^')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S7',fRref.S7'], 'b','^')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S8',fRref.S8'], 'm','^')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S9',fRref.S9'], 'r','^')
[ media_vett, diff, mod, loa1, loa2, amp_loa] = Bland( [fPCA_nonred.S10',fRref.S10'], 'c','^')
MOD=mean(-BbB_reference_static+BbB_PCA_static)
diff=(-BbB_reference_static+BbB_PCA_static);
loa1=MOD+(1.96*std(diff));
loa2=MOD-(1.96*std(diff));
