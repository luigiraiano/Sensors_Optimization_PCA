...
% main script main_ElabNoIMU_SensorsPlacementOptimizazion_PCA_v3.
%
% Differently to v1, in this second version we use the integral of the
% spirp signal to perform the correlation, congruently with the
...
%
%%
function [subjs_out, corr_out] =Run_Correlation_PC1_Spiro_FreqDomain_v2(subjs_in)
subjs_out = subjs_in;
corr_out = [];
