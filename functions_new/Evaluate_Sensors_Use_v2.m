...
%
%%
function [sensors_perc_use_over_subjects_cell, sensors_perc_use_over_speeds_cell, sensors_perc_use_overall_cell] = Evaluate_Sensors_Use_v2(subjs_in)
