...
% original ones, the cleaned ones and the non-redundant ones
...
%%
function [subjs_out, corr_out] = Run_Correlation_AveSensors_Spiro_v1(subjs_in,domain_analysis,textitle_signal_flag,spiro_signal_integral)
