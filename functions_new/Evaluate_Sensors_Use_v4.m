...
%
%%
function [sensors_perc_use_over_subjects_cell, sensors_perc_use_over_speeds_cell, sensors_perc_use_overall_cell, n_sensors_used] = Evaluate_Sensors_Use_v4(subjs_in)
